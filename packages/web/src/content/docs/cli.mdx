...
| `OPENCODE_ENABLE_EXA`                 | boolean | Enable the Exa-backed code search tool                        |
| `PARALLEL_API_KEY`                    | string  | API key for Parallel AI web search (fallback when `/parallel` not used) |
